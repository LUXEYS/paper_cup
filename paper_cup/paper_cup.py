...
class PaperCup():
  ...
  QUEUE = 'my_queue' # Consumer
  PAPER_CUP_ENABLE = True
  PAPER_CUP_LISTEN = []
  PAPER_CUP_SENDER = 'this_app_name'
  ...
  def _add_more_data(self, message, action):
    ...
    message['sender'] = self.PAPER_CUP_SENDER
    return message
  ...
  def run(self):
    ...
    for message in messages:
      ...
      if sender in self.PAPER_CUP_LISTEN:
